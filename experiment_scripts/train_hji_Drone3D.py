...
p.add_argument('--experiment_name', type=str, required=False,default='test0',
               help='Name of subdirectory in logging_root where summaries and checkpoints will be saved.')

# General training options
p.add_argument('--batch_size', type=int, default=32)
p.add_argument('--lr', type=float, default=2e-5, help='learning rate. default=2e-5')
p.add_argument('--num_epochs', type=int, default=120000, help='Number of epochs to train for.')#
p.add_argument('--adjust_relative_grads', type=bool, default=False, help='loss gradient adjust')#
...
# Define the loss
loss_fn = loss_functions.initialize_hji_drone3D(dataset, opt.minWith)
